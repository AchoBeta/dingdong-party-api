...
public interface PartyUserActivityService extends IService<PartyUserActivity> {
     ...
     * @param groupId    党组id
     */
    void addUsers(List<String> userIds, String activityId, String branchId, String groupId);
     ...
     * @param reason     原因
     */
    void leave(String activityId, String userId, String reason);
     ...
     * @param userId     用户id
     */
    void participate(String activityId, String userId);
     ...
     * @return 查询结果
     */
    List<UserActivityVO> query(String userId, String activityId, Integer status, String branchId, String groupId, Integer page, Integer size);
